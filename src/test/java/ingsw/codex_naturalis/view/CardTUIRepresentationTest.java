...
//        }
    ...
    void playerAreaToStringTest(){
        ...
        card.flip();
        playerArea.setCardOnCoordinates(card,0,0);

        playerArea.setCardOnCoordinates(resourceCardsDeck.drawACard(),1,1);
        card = resourceCardsDeck.drawACard();
        //card.flip();
        card = resourceCardsDeck.drawACard();
        //card.flip();
        playerArea.setCardOnCoordinates(card,2,0);
        playerArea.setCardOnCoordinates(resourceCardsDeck.drawACard(),3,1);
        playerArea.setCardOnCoordinates(resourceCardsDeck.drawACard(),2,2);
        card = resourceCardsDeck.drawACard();
        //card.flip();
        playerArea.setCardOnCoordinates(card,1,3);
        card = resourceCardsDeck.drawACard();
        //card.flip();
        playerArea.setCardOnCoordinates(card,0,4);
        playerArea.setCardOnCoordinates(resourceCardsDeck.drawACard(),1,5);
        playerArea.setCardOnCoordinates(resourceCardsDeck.drawACard(),2,6);
        playerArea.setCardOnCoordinates(resourceCardsDeck.drawACard(),3,5);
        playerArea.setCardOnCoordinates(resourceCardsDeck.drawACard(),-1,1);
        playerArea.setCardOnCoordinates(resourceCardsDeck.drawACard(),-1,3);
        playerArea.setCardOnCoordinates(resourceCardsDeck.drawACard(),4,6);
        playerArea.setCardOnCoordinates(resourceCardsDeck.drawACard(),3,3);
        playerArea.setCardOnCoordinates(resourceCardsDeck.drawACard(),5,5);
        playerArea.setCardOnCoordinates(resourceCardsDeck.drawACard(),6,4);
